...
D:\Qt4.8.4\bin\qmake.exe ^
	BOOST_INCLUDE_PATH=libs/boost_1_54_0 ^
	BOOST_LIB_PATH=libs/boost_1_54_0/stage/lib ^
	BOOST_LIB_SUFFIX=-mgw46-mt-1_54 ^
	OPENSSL_INCLUDE_PATH=libs/openssl-1.0.1e/include ^
	BDB_INCLUDE_PATH=libs/db-4.8.30.NC/build_unix ^
	BDB_LIB_PATH=libs/db-4.8.30.NC/build_unix ^
	OPENSSL_LIB_PATH=libs/openssl-1.0.1e ^
	MINIUPNPC_INCLUDE_PATH=libs/miniupnpc-1.8 ^
	MINIUPNPC_LIB_PATH=libs/miniupnpc-1.8
